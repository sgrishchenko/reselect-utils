...
export interface ParametricSelectorBuilder<S, P, R, D> {
    ...
    (nullDefaultValue: R extends null ? null : never): ParametricSelector<S, P, Defined<R>, D>;
}
...
export type PathParametricSelectorType<S, P, R, D> = ParametricSelectorBuilder<S, P, R, D>
